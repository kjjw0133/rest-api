...
#### 구현 중
+ 친구 추가 기능 : 마이페이지에서 친구 확인, 친구 추가 수락 버튼(클릭 시 1에서 2로 변경), 거절 버튼(1에서 0으로 변경), DB에 친구 컬럼을 만들어서 기본은 0, 친구 추가 요청 1, 친구 추가 2로 변경 , 채팅방 생성 시 친구들 초대하여 바로 친구들과 채팅 가능, 새로운 폼에서 친구 목록에서 클릭하여 선택 가능, 
